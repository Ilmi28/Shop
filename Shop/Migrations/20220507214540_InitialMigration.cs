        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GeneralAmountOfStuff = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RawPrice = table.Column<float>(type: "real", nullable: false),
                    DeliveryPrice = table.Column<float>(type: "real", nullable: true),
                    PaymentPrice = table.Column<float>(type: "real", nullable: true),
                    TotalPrice = table.Column<float>(type: "real", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: true),
                    OrderPaid = table.Column<bool>(type: "bit", nullable: false),
                    OrderToken = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Refreshening = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DefaultPhoto = table.Column<bool>(type: "bit", nullable: false),
                    MonitorPhoto = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductNativeId = table.Column<int>(type: "int", nullable: false),
